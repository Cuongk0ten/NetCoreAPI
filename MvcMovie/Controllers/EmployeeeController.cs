...
namespace MvcMovie.Controllers
{
    public class EmployeeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Tuoi,sodienthoai,PersonId,FullName,Address")] Employeee employeee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Tuoi,sodienthoai,PersonId,FullName,Address")] Employeee employeee)
        {
            if (id != employeee.PersonId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!EmployeeeExists(employeee.PersonId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Employeee.Any(e => e.PersonId == id);
        }
    }
}
